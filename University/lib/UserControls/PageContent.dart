...
class PageContent extends StatefulWidget {
  ...
  @override
  createState() => PageContentState();
}

class PageContentState extends PageBase<PageContent> with WidgetsBindingObserver {
  ...
  @override
  void initState() {
    paddingPageContentRight = adaptiveScrollWidth;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
   return LayoutBuilder(builder: (context, constraints) {
     ...
     if(CommonMethod.isWebOrDesktop()){
       debugPrint("[PageContent-WebOrDesktop]");
