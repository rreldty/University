...
class LookupPage
{
  ...
  int intPageNumber = 1;
  int intPageSize = AppConfig.PageSize;
  ...
  Future<String?> showLookup({
    ...
    //debugPrint("show Lookup");
    LookupDto objLookup = await getInitialData();

    // debugPrint("w: ${objLookup.WindowSize}");

    if(objLookup.WindowSize.isNotEmpty){
      List<String> windowSize = objLookup.WindowSize.split(";");
